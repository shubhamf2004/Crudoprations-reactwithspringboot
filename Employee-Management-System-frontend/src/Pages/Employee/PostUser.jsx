        ...
        <div className="min-h-screen bg-[#f8fafc] py-12 px-4 sm:px-6 lg:px-8">
            <div className="max-w-4xl mx-auto">
                <div className="mb-10 flex items-center justify-between">
                    <div>
                        <h1 className="text-4xl font-bold text-slate-800 tracking-tight mb-2 uppercase">Add New Employee</h1>
                        <p className="text-slate-500 font-medium tracking-tight">Onboard a new member to the organization.</p>
                    </div>
                    <button
                        ...
                        <div className="p-8 lg:p-12 min-h-[400px]">
                            {currentTab === 'identity' && (
                                <div className="space-y-8 animate-fade-in-up">
                                    ...
                                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                                        <FormInput icon={<FaUser />} label="Full Name" name="name" value={formData.name} onChange={handleInputChange} placeholder="Marcus Aurelius" />
                                        <FormInput icon={<FaEnvelope />} label="Email Address" name="email" type="email" value={formData.email} onChange={handleInputChange} placeholder="m.aurelius@company.com" />
                                        <FormInput icon={<FaPhone />} label="Phone Number" name="phone" value={formData.phone} onChange={handleInputChange} placeholder="+1 (000) 000-0000" />
                                        <FormInput icon={<FaMapMarkerAlt />} label="City" name="city" value={formData.city} onChange={handleInputChange} placeholder="San Francisco" />
                                    ...
                                    <div className="pt-6 border-t border-slate-50">
                                        ...
                                        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mt-8">
                                            <FormInput icon={<FaLinkedin />} label="LinkedIn" name="linkedin" value={formData.linkedin} onChange={handleInputChange} placeholder="Username" />
                                            <FormInput icon={<FaTwitter />} label="Twitter" name="twitter" value={formData.twitter} onChange={handleInputChange} placeholder="@username" />
                                            <FormInput icon={<FaInstagram />} label="Instagram" name="instagram" value={formData.instagram} onChange={handleInputChange} placeholder="Username" />
                                        </div>
                                    </div>
                                </div>
                            )}
                            ...
                            {currentTab === 'professional' && (
                                <div className="space-y-8 animate-fade-in-up">
                                    ...
                                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                                        <FormInput icon={<FaIdBadge />} label="Employee ID" name="employeeId" value={formData.employeeId} onChange={handleInputChange} placeholder="EMP-0000" />
                                        <FormInput icon={<FaBuilding />} label="Department" name="department" value={formData.department} onChange={handleInputChange} placeholder="Engineering" />
                                        <FormInput icon={<FaBriefcase />} label="Designation" name="designation" value={formData.designation} onChange={handleInputChange} placeholder="Senior Architect" />
                                        <FormSelect
                                            icon={<FaClock />}
                                        ...
                                        <FormInput icon={<FaClock />} label="Previous Experience" name="experience" value={formData.experience} onChange={handleInputChange} placeholder="e.g. 5 Years" />
                                    </div>
                                </div>
                            )}
                            ...
                            {currentTab === 'benefits' && (
                                <div className="space-y-8 animate-fade-in-up">
                                    ...
                                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                                        <FormInput icon={<FaWallet />} label="Base Annual Salary" name="salary" type="number" value={formData.salary} onChange={handleInputChange} placeholder="00,000" />
                        ...
                        <div className="p-6 lg:p-10 border-t border-slate-100 bg-slate-50/30 flex gap-4">
                            ...
                            >
                                {saving ? (
                                    ...
                                    <>
                                        <FaCheckCircle className="group-hover:scale-110 transition-transform" /> Save Personnel Record
                                    </>
                                )}
                            </button>
                        </div>
